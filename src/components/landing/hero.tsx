      ...
      <div className="absolute top-[120px] md:top-[22vh] left-1/2 transform -translate-x-1/2 z-10 text-center px-4 w-full">
        <div className="mb-3 sm:mb-4 md:mb-6">
          <div className="TopPill w-[21rem] sm:w-[327px] md:w-[327px] h-[1.875rem] sm:h-[31.20px] md:h-[31.20px] relative bg-[#1a1b20] rounded-3xl overflow-hidden mx-auto">
            ...
            <div className="Label left-[1.625rem] sm:left-[27.60px] md:left-[27.60px] right-[0.5rem] sm:right-[8px] md:right-[8px] top-[0.265625rem] sm:top-[4.60px] md:top-[4.60px] absolute justify-start text-[#f2c6a6] text-[0.875rem] sm:text-sm font-medium font-['Inter'] leading-snug whitespace-nowrap">AI AUTOMATION PARTNER FOR FOUNDERS</div>
          </div>
        </div>
      </div>
