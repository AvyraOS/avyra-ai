          ...
          <div className="hidden lg:flex flex-col items-start lg:order-1">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-[rgba(255,255,255,0.0)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center hover:bg-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.2)] transition-all duration-300"
              >
                <Image
                  src="/icons/x.svg"
                  alt="X (Twitter)"
              ...
              <a 
                href="https://www.tiktok.com/@avyraai" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-[rgba(255,255,255,0.0)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center hover:bg-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.2)] transition-all duration-300"
              >
